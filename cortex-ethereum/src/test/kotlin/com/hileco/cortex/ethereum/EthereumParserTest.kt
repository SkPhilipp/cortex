...
class EthereumParserTest {
    ...
    fun parse() {
        ...
        Documentation.of(EthereumParser::class.java.simpleName)
                ...
                .paragraph("Using this on barrier000.sol's bytecode yields instructions:")
                .source(instructions)
    ...
    fun parseTransaction() {
        ...
        Documentation.of(EthereumParser::class.java.simpleName)
                .headingParagraph("Transaction Parsing")
                .paragraph("Using this on bytecode of a contract creation transaction:")
                .source(bytecode)
                .paragraph("yields Ethereum instructions:")
                .source(ethereumInstructions)
