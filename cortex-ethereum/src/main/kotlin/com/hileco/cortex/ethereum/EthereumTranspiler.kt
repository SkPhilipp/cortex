...
class EthereumTranspiler {
    private fun map(ethereumInstruction: EthereumInstruction): Instruction {
        return when (ethereumInstruction.operation) {
            ...
            EthereumOperation.PUSH1 -> PUSH(ethereumInstruction.input, width = 1)
            EthereumOperation.PUSH2 -> PUSH(ethereumInstruction.input, width = 2)
            EthereumOperation.PUSH3 -> PUSH(ethereumInstruction.input, width = 3)
            EthereumOperation.PUSH4 -> PUSH(ethereumInstruction.input, width = 4)
            EthereumOperation.PUSH5 -> PUSH(ethereumInstruction.input, width = 5)
            EthereumOperation.PUSH6 -> PUSH(ethereumInstruction.input, width = 6)
            EthereumOperation.PUSH7 -> PUSH(ethereumInstruction.input, width = 7)
            EthereumOperation.PUSH8 -> PUSH(ethereumInstruction.input, width = 8)
            EthereumOperation.PUSH9 -> PUSH(ethereumInstruction.input, width = 9)
            EthereumOperation.PUSH10 -> PUSH(ethereumInstruction.input, width = 10)
            EthereumOperation.PUSH11 -> PUSH(ethereumInstruction.input, width = 11)
            EthereumOperation.PUSH12 -> PUSH(ethereumInstruction.input, width = 12)
            EthereumOperation.PUSH13 -> PUSH(ethereumInstruction.input, width = 13)
            EthereumOperation.PUSH14 -> PUSH(ethereumInstruction.input, width = 14)
            EthereumOperation.PUSH15 -> PUSH(ethereumInstruction.input, width = 15)
            EthereumOperation.PUSH16 -> PUSH(ethereumInstruction.input, width = 16)
            EthereumOperation.PUSH17 -> PUSH(ethereumInstruction.input, width = 17)
            EthereumOperation.PUSH18 -> PUSH(ethereumInstruction.input, width = 18)
            EthereumOperation.PUSH19 -> PUSH(ethereumInstruction.input, width = 19)
            EthereumOperation.PUSH20 -> PUSH(ethereumInstruction.input, width = 20)
            EthereumOperation.PUSH21 -> PUSH(ethereumInstruction.input, width = 21)
            EthereumOperation.PUSH22 -> PUSH(ethereumInstruction.input, width = 22)
            EthereumOperation.PUSH23 -> PUSH(ethereumInstruction.input, width = 23)
            EthereumOperation.PUSH24 -> PUSH(ethereumInstruction.input, width = 24)
            EthereumOperation.PUSH25 -> PUSH(ethereumInstruction.input, width = 25)
            EthereumOperation.PUSH26 -> PUSH(ethereumInstruction.input, width = 26)
            EthereumOperation.PUSH27 -> PUSH(ethereumInstruction.input, width = 27)
            EthereumOperation.PUSH28 -> PUSH(ethereumInstruction.input, width = 28)
            EthereumOperation.PUSH29 -> PUSH(ethereumInstruction.input, width = 29)
            EthereumOperation.PUSH30 -> PUSH(ethereumInstruction.input, width = 30)
            EthereumOperation.PUSH31 -> PUSH(ethereumInstruction.input, width = 31)
            EthereumOperation.PUSH32 -> PUSH(ethereumInstruction.input, width = 32)
