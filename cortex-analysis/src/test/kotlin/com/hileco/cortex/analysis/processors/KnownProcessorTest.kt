...
import com.hileco.cortex.vm.instructions.stack.ExecutionVariable.INSTRUCTION_POSITION
...
class KnownProcessorTest : ProcessorFuzzTest() {
    ...
    fun process() {
        ...
        Documentation.of(KnownProcessor::class.java.simpleName)
                .headingParagraph(KnownProcessor::class.java.simpleName)
