...
- [ ] Virtual Machine running programs calling programs as libraries
...
- [ ] Generated solution for barrier program generated as another program
- [ ] Generated solution for barrier program involving multiple calls
- [ ] Document database containing all barrier programs' source
- [ ] Document database containing all barrier programs' state
- [ ] Generated solution for a state-bound barrier program in database
- [ ] Automated solving and progress tracking of all barrier programs in database
...
* OperationsTest organized like instruction classes
