...
public class ParameterProcessorTest extends ProcessorFuzzTest {
    ...
    public void process() {
        ...
        Documentation.of(ParameterProcessor.class.getSimpleName())
                .headingParagraph(ParameterProcessor.class.getSimpleName())
